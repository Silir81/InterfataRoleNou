...
# Function to recreate dropdown with new values
def create_dropdown(values):
    global dropdown_var, dropdown
    if 'dropdown' in globals():
        dropdown.destroy()
    dropdown_var = tk.StringVar()
    dropdown = ctk.CTkOptionMenu(tab1_frame, variable=dropdown_var, values=values)
...
# Create initial empty dropdown in Tab 1
create_dropdown([])
